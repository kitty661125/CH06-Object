...
//        startmusic.start();
    ...
    private void u_setalpha() {
        ...
        btnScissors.getBackground().setAlpha(0); //0-255 //設定  剪刀_button 背景 透明度 0(全透明) //設定  剪刀_button 背景 透明度 255(不透明)
...
//                            txtResult.setTextColor(getResources().getColor(R.color.Lime));
                ...
                case R.id.m0605_b002: //選擇石頭
                    user_select = getString(R.string.m0605_s001) + "  "+
                            getString(R.string.m0605_b002);
                    u_setalpha();
...
//                            ff= getString(R.string.m0605_f000)+"   "+getString(R.string.m0605_f001);
//                            txtResult.setTextColor(getResources().getColor(R.color.Yellow));
                            music(2);
                            break;
                        case 3:
    ...
    private void music(int i) {
        ...
        switch(i){
            ...
            case 1://贏
                ...
                ff = getString(R.string.m0605_f000) + "  " + getString(R.string.m0605_f003);
                txtResult.setTextColor(getResources().getColor(R.color.Lime));
                Toast.makeText(getApplicationContext(),getString(R.string.m0605_f003), Toast.LENGTH_LONG).show();
            ...
            case 2://平手
                ...
                ff= getString(R.string.m0605_f000)+"   "+getString(R.string.m0605_f001);
                txtResult.setTextColor(getResources().getColor(R.color.Yellow));
                Toast.makeText(getApplicationContext(),getString(R.string.m0605_f001), Toast.LENGTH_LONG).show();
            ...
            case 3://輸
                ...
                ff=getString(R.string.m0605_f000)+"  "+getString(R.string.m0605_f002);
                txtResult.setTextColor(getResources().getColor(R.color.Red));
                Toast.makeText(getApplicationContext(),getString(R.string.m0605_f002), Toast.LENGTH_LONG).show();
